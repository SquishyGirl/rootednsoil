...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Parvati_Typography_Customize_Control' ) ) {
	/**
	 * Create the typography elements control.
	 *
	 */
	class Parvati_Typography_Customize_Control extends WP_Customize_Control {
		public $type = 'parvati-customizer-typography';

		public function enqueue() {
			wp_enqueue_script( 'parvati-typography-selectWoo', trailingslashit( get_template_directory_uri() )  . 'inc/customizer/controls/js/selectWoo.min.js', array( 'customize-controls', 'jquery' ), PARVATI_VERSION, true );
			wp_enqueue_style( 'parvati-typography-selectWoo', trailingslashit( get_template_directory_uri() )  . 'inc/customizer/controls/css/selectWoo.min.css', array(), PARVATI_VERSION );

			wp_enqueue_script( 'parvati-typography-customizer', trailingslashit( get_template_directory_uri() )  . 'inc/customizer/controls/js/typography-customizer.js', array( 'customize-controls', 'parvati-typography-selectWoo' ), PARVATI_VERSION, true );
			wp_enqueue_style( 'parvati-typography-customizer', trailingslashit( get_template_directory_uri() )  . 'inc/customizer/controls/css/typography-customizer.css', array(), PARVATI_VERSION );
		}
		...
		public function to_json() {
			...
			$this->json[ 'default_fonts_title'] = __( 'System fonts', 'parvati' );
			$this->json[ 'google_fonts_title'] = __( 'Google fonts', 'parvati' );
			...
			$this->json[ 'family_title' ] = esc_html__( 'Font family', 'parvati' );
			$this->json[ 'weight_title' ] = esc_html__( 'Font weight', 'parvati' );
			$this->json[ 'transform_title' ] = esc_html__( 'Text transform', 'parvati' );
			$this->json[ 'category_title' ] = '';
			$this->json[ 'variant_title' ] = esc_html__( 'Variants', 'parvati' );
		...
		public function content_template() {
			...
			<# if ( 'undefined' !== typeof ( data.category ) ) { #>
				<div class="parvati-font-category">
					<label>
							<input name="{{{ data.category.id }}}" type="hidden" {{{ data.category.link }}} value="{{{ data.category.value }}}" class="parvati-hidden-input" />
