...
class Widget_WPKoi_Elements_Adv_Accordion extends Widget_Base {
	...
	?>
	<div class="wpkoi-elements-adv-accordion" id="wpkoi-elements-adv-accordion-<?php echo esc_attr( $this->get_id() ); ?>">
		...
		<div class="wpkoi-elements-accordion-list">
			<div class="wpkoi-elements-accordion-header<?php if( $tab['wpkoi_elements_adv_accordion_tab_default_active'] == 'yes' ) : echo ' active-default'; endif; ?>">
				...
				else : ?><i class="<?php echo $tab['wpkoi_elements_adv_accordion_tab_title_icon']; ?> fa-accordion-icon" aria-hidden="true"></i> <?php endif;
				endif; 
				echo $tab['wpkoi_elements_adv_accordion_tab_title']; ?></span> 
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_WPKoi_Elements_Adv_Accordion() );