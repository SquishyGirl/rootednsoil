...
class WPKoi_Elements_Animated_Text extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default' => array(
					array(
						'item_text' => esc_html__( 'Create', 'wpkoi-elements' ),
					),
					array(
						'item_text' => esc_html__( 'Animate', 'wpkoi-elements' ),
					),
				),
	...
	protected function render() {
		...
		$classes[] = 'wpkoi-animated-text--effect-' . $settings['animation_effect'];
		...
		<div class="<?php echo implode( ' ', $classes ); ?>" <?php echo $data_settings; ?>>
            ...
            <div class="wpkoi-animated-text__animated-text">
				<?php foreach( $settings['animated_text_list'] as $animatetext ) : ?>
					<?php 
...
Plugin::instance()->widgets_manager->register_widget_type( new WPKoi_Elements_Animated_Text() );