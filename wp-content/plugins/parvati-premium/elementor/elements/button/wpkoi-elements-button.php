...
class WPKoi_Elements_Button extends Widget_Base {
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wpkoi-button', 'class', 'wpkoi-button__instance--icon-' . $position );
		$this->add_render_attribute( 'wpkoi-button', 'class', 'hover-' . $hover_effect );
		
		$tag = 'div';
		
		if ( ! empty( $settings['button_url']['url'] ) ) {
			$this->add_render_attribute( 'wpkoi-button', 'href', $settings['button_url']['url'] );
		...
		<div class="wpkoi-button__container">
			<<?php echo $tag; ?> <?php echo $this->get_render_attribute_string( 'wpkoi-button' ); ?>>
					...
					<?php
						if ( filter_var( $use_icon, FILTER_VALIDATE_BOOLEAN ) ) {
							...
							if ( $is_new || $migrated ) :
								...
								echo '<i class="' . $settings['button_icon_normal'] . '" aria-hidden="true"></i>';
							endif;
							echo '</span>';
						}
						echo '<span class="wpkoi-button__label">' . $settings['button_label_normal'] . '</span>';
					?>
				</div>
					...
					<?php
						if ( filter_var( $use_icon, FILTER_VALIDATE_BOOLEAN ) ) {
							...
							if ( $is_new || $migrated ) :
								...
								echo '<i class="' . $settings['button_icon_hover'] . '" aria-hidden="true"></i>';
							endif;
							echo '</span>';
						}
						echo '<span class="wpkoi-button__label">' . $settings['button_label_hover'] . '</span>';
					?>
				</div>
			</<?php echo $tag; ?>>
		</div>
...
Plugin::instance()->widgets_manager->register_widget_type( new WPKoi_Elements_Button() );