<?php
/**
 * Class: WPKoi_Elements_Image_Comparison
 * Name: Image Comparison
 * Slug: wpkoi-image-comparison
 */
...
class WPKoi_Elements_Image_Comparison extends Widget_Base {

	public function get_name() {
		return 'wpkoi-image-comparison';
	}

	public function get_title() {
		return esc_html__( 'Image Comparison', 'wpkoi-elements' );
	}
	...
	protected function register_controls() {
		$css_scheme = apply_filters(
			'wpkoi-elements/image-comparison/css-scheme',
			array(
				'instance'         => '.wpkoi-image-comparison__instance',
		...
		$repeater->add_control(
			'item_before_label',
			array(
				'label'   => esc_html__( 'Before Label', 'wpkoi-elements' ),
		...
		$repeater->add_control(
			'item_before_image',
			array(
				'label'   => esc_html__( 'Before Image', 'wpkoi-elements' ),
		...
		$repeater->add_control(
			'item_after_label',
			array(
				'label'   => esc_html__( 'After Label', 'wpkoi-elements' ),
				'type'    => Controls_Manager::TEXT,
			)
		);
		...
		$repeater->add_control(
			'item_after_image',
			array(
				'label'   => esc_html__( 'After Image', 'wpkoi-elements' ),
				'type'    => Controls_Manager::MEDIA,
				'dynamic' => array(
					'active' => true,
					'categories' => array(
		...
		$this->add_control(
			'item_list',
			array(
				'label'   => esc_html__( 'Images', 'wpkoi-elements' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
				'default'     => array(
					array(
						'item_before_label' => esc_html__( 'Before', 'wpkoi-elements' ),
						'item_before_image' => array(
							'url' => Utils::get_placeholder_image_src(),
						),
						'item_after_label' => esc_html__( 'After', 'wpkoi-elements' ),
		...
		$this->add_responsive_control(
			'slides_to_show',
			array(
				'label'   => esc_html__( 'Slides to Show', 'wpkoi-elements' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '1',
				'options' => wpkoi_elements_tools()->get_select_range( 10 ),
			)
		);
		...
		$this->add_control(
			'slides_to_scroll',
			array(
				'label'     => esc_html__( 'Slides to Scroll', 'wpkoi-elements' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '1',
				'options'   => wpkoi_elements_tools()->get_select_range( 10 ),
				'condition' => array(
		...
		$this->add_control(
			'arrows',
			array(
				'label'        => esc_html__( 'Show Arrows Navigation', 'wpkoi-elements' ),
		...
		$this->add_control(
			'prev_arrow',
			array(
				'label'   => esc_html__( 'Prev Arrow Icon', 'wpkoi-elements' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'fa fa-angle-left',
				'options' => wpkoi_elements_tools()->get_available_prev_arrows_list(),
				'condition' => array(
					'arrows' => 'true',
				),
			)
		...
		$this->add_control(
			'next_arrow',
			array(
				'label'   => esc_html__( 'Next Arrow Icon', 'wpkoi-elements' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'fa fa-angle-right',
				'options' => wpkoi_elements_tools()->get_available_next_arrows_list(),
				'condition' => array(
					'arrows' => 'true',
				),
			)
		...
		$this->add_control(
			'dots',
			array(
				'label'        => esc_html__( 'Show Dots Navigation', 'wpkoi-elements' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'wpkoi-elements' ),
				'label_off'    => esc_html__( 'No', 'wpkoi-elements' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'infinite',
			array(
				'label'        => esc_html__( 'Infinite Loop', 'wpkoi-elements' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'wpkoi-elements' ),
				'label_off'    => esc_html__( 'No', 'wpkoi-elements' ),
				'return_value' => 'true',
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'slide',
				'options' => array(
					'slide' => esc_html__( 'Slide', 'wpkoi-elements' ),
		...
		$this->add_control(
			'autoplay_speed',
			array(
				'label'     => esc_html__( 'Autoplay Speed', 'wpkoi-elements' ),
		...
		$this->start_controls_tab(
			'tab_label_before',
			array(
				'label' => esc_html__( 'Before', 'wpkoi-elements' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Horizontal Alignment', 'wpkoi-elements' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'flex-start',
				'options' => array(
					'flex-start'    => esc_html__( 'Left', 'wpkoi-elements' ),
					'center'        => esc_html__( 'Center', 'wpkoi-elements' ),
					'flex-end'      => esc_html__( 'Right', 'wpkoi-elements' ),
				),
				'selectors'  => array(
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Vertical Alignment', 'wpkoi-elements' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'flex-start',
				'options' => array(
					'flex-start'    => esc_html__( 'Top', 'wpkoi-elements' ),
					'center'        => esc_html__( 'Center', 'wpkoi-elements' ),
					'flex-end'      => esc_html__( 'Bottom', 'wpkoi-elements' ),
				),
				'selectors'  => array(
		...
		$this->start_controls_tab(
			'tab_label_after',
			array(
				'label' => esc_html__( 'After', 'wpkoi-elements' ),
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Handle', 'wpkoi-elements' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Control Width', 'wpkoi-elements' ),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Handle Divider', 'wpkoi-elements' ),
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Divider Width', 'wpkoi-elements' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Divider Color', 'wpkoi-elements' ),
				'type'    => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_responsive_control(
			'starting_position',
			array(
				'label'      => esc_html__( 'Divider Starting Position', 'wpkoi-elements' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( '%' ),
				'range'      => array(
					'%' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Handle Arrow', 'wpkoi-elements' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Arrows', 'wpkoi-elements' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'           => 'arrows_style',
				'label'          => esc_html__( 'Arrows Style', 'wpkoi-elements' ),
		...
		$this->add_control(
			'prev_arrow_position',
			array(
				'label'     => esc_html__( 'Prev Arrow Position', 'wpkoi-elements' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'prev_vert_position',
			array(
				'label'   => esc_html__( 'Vertical Position by', 'wpkoi-elements' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'top',
				'options' => array(
		...
		$this->add_responsive_control(
			'prev_top_position',
			array(
				'label'      => esc_html__( 'Top Indent', 'wpkoi-elements' ),
				'type'       => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Bottom Indent', 'wpkoi-elements' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%', 'em' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			'prev_hor_position',
			array(
				'label'   => esc_html__( 'Horizontal Position by', 'wpkoi-elements' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'left',
				'options' => array(
		...
		$this->add_responsive_control(
			'prev_left_position',
			array(
				'label'      => esc_html__( 'Left Indent', 'wpkoi-elements' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%', 'em' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_responsive_control(
			'prev_right_position',
			array(
				'label'      => esc_html__( 'Right Indent', 'wpkoi-elements' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%', 'em' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			'next_arrow_position',
			array(
				'label'     => esc_html__( 'Next Arrow Position', 'wpkoi-elements' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'dots_gap',
			array(
				'label' => esc_html__( 'Gap', 'wpkoi-elements' ),
				'type' => Controls_Manager::SLIDER,
				'default' => array(
					'size' => 5,
					'unit' => 'px',
		...
		$this->add_control(
			'dots_margin',
			array(
				'label'      => esc_html__( 'Dots Box Margin', 'wpkoi-elements' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
	...
	protected function render() {
		...
		$classes_list[] = 'wpkoi-image-comparison';
		...
		<div class="<?php echo $classes; ?>">
			...
			$class_array[] = 'wpkoi-image-comparison__instance';
			$class_array[] = 'elementor-slick-slider';
			
			$classesx = implode( ' ', $class_array );
			
			$dir = is_rtl() ? 'rtl' : 'ltr';
			
			?>
			<div class="<?php echo $classesx; ?>" <?php echo $data_settings; ?> dir="<?php echo $dir; ?>">
            <?php
			...
			foreach( $settings['item_list'] as $compimg ) :
			$item_before_label = $compimg['item_before_label'];
			$item_before_image = $compimg['item_before_image']['url'];
			$item_after_label = $compimg['item_after_label'];
			$item_after_image = $compimg['item_after_image']['url'];
			
			?>
			<div class="wpkoi-image-comparison__item">
				<div class="wpkoi-image-comparison__container wpkoi-juxtapose" data-prev-icon="<?php echo $prevArrow; ?>" data-next-icon="<?php echo $nextArrow; ?>" data-makeresponsive="true" data-startingposition="<?php echo $starting_position_string; ?>">
					<img class="wpkoi-image-comparison__before-image" src="<?php echo $item_before_image; ?>" data-label="<?php echo $item_before_label; ?>" alt="">
					<img class="wpkoi-image-comparison__after-image" src="<?php echo $item_after_image; ?>" data-label="<?php echo $item_after_label; ?>" alt="">
				</div>
			</div>
            <?php endforeach; ?>
            </div>
	...
	public function generate_setting_json() {
		...
		$instance_settings = array(
			...
			'prevArrow'      => wpkoi_elements_tools()->get_carousel_arrow(
				array( $settings['prev_arrow'], 'prev-arrow' )
			),
			'nextArrow'      => wpkoi_elements_tools()->get_carousel_arrow(
...
Plugin::instance()->widgets_manager->register_widget_type( new WPKoi_Elements_Image_Comparison() );