(function( $ ){	
	 ...
	 * Navigation width
	 */
	wp.customize( 'parvati_secondary_nav_settings[secondary_nav_layout_setting]', function( value ) {
		value.bind( function( newval ) {
			if ( 'secondary-fluid-nav' == newval ) {
				$( '.secondary-navigation' ).removeClass( 'grid-container' ).removeClass( 'grid-parent' );
				if ( 'full-width' !== wp.customize.value('parvati_secondary_nav_settings[secondary_nav_inner_width]')() ) {
	 ...
	 */
	wp.customize( 'parvati_secondary_nav_settings[secondary_nav_inner_width]', function( value ) {
		value.bind( function( newval ) {
	 ...
	 * Navigation position
	 */
	wp.customize( 'parvati_secondary_nav_settings[secondary_nav_position_setting]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'parvati_secondary_nav_settings[secondary_nav_alignment]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'parvati_secondary_nav_settings[secondary_menu_item]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'parvati_secondary_nav_settings[secondary_menu_item_height]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'parvati_secondary_nav_settings[secondary_sub_menu_item_height]', function( value ) {
		value.bind( function( newval ) {
