...
require_once trailingslashit( dirname(__FILE__) ) . 'fixed-side-fonts.php';
...
if ( ! function_exists( 'parvati_fonts_customize_register' ) ) {
	add_action( 'customize_register', 'parvati_fonts_customize_register' );
	/**
	 * Build the Customizer controls.
	 *
	 */
	function parvati_fonts_customize_register( $wp_customize ) {
		...
		if ( class_exists( 'WP_Customize_Panel' ) ) {
			$wp_customize->add_panel( 'parvati_typography_panel', array(
				'priority'       => 30,
				'capability'     => 'edit_theme_options',
				'theme_supports' => '',
				'title'          => __( 'Typography', 'parvati-premium' ),
				'description'    => '',
			) );
		}
		...
		// Font weight
		$wp_customize->add_setting(
			'parvati_settings[body_font_weight]',
			array(
		...
		// Text transform
		$wp_customize->add_setting(
			'parvati_settings[body_font_transform]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Typography_Customize_Control(
				...
				array(
					...
					'priority' => 1,
					'settings' => array(
						'family' => 'parvati_settings[font_body]',
						'variant' => 'font_body_variants',
						'category' => 'font_body_category',
						'weight' => 'parvati_settings[body_font_weight]',
						'transform' => 'parvati_settings[body_font_transform]',
					),
				)
			)
		);
		...
		// Font size
		$wp_customize->add_setting(
			'parvati_settings[body_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Range_Slider_Control(
				...
				array(
					...
					'priority' => 40,
					'settings' => array(
						'desktop' => 'parvati_settings[body_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 6,
		...
		// Line height
		$wp_customize->add_setting(
			'parvati_settings[body_line_height]',
			array(
				'default' => $defaults['body_line_height'],
				'type' => 'option',
				'sanitize_callback' => 'parvati_premium_sanitize_decimal_integer',
				'transport' => 'postMessage'
			)
		);
		...
		$wp_customize->add_control(
			new Parvati_Pro_Range_Slider_Control(
				...
				'parvati_settings[body_line_height]',
				array(
					'description' => __( 'Line height', 'parvati-premium' ),
					'section' => 'font_section',
					'priority' => 45,
					'settings' => array(
						'desktop' => 'parvati_settings[body_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 1,
		...
		// Paragraph margin
		$wp_customize->add_setting(
			'parvati_settings[paragraph_margin]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Range_Slider_Control(
				...
				'parvati_settings[paragraph_margin]',
				array(
					'description' => __( 'Paragraph margin', 'parvati-premium' ),
					'section' => 'font_section',
					'priority' => 47,
					'settings' => array(
						'desktop' => 'parvati_settings[paragraph_margin]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 0,
		...
		if ( isset( $defaults[ 'font_top_bar' ] ) && function_exists( 'parvati_is_top_bar_active' ) ) {

			// Font family
			$wp_customize->add_setting(
				'parvati_settings[font_top_bar]',
				array(
			...
			// Font weight
			$wp_customize->add_setting(
				'parvati_settings[top_bar_font_weight]',
				array(
			...
			// Text transform
			$wp_customize->add_setting(
				'parvati_settings[top_bar_font_transform]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Typography_Customize_Control(
					...
					'top_bar_typography',
					array(
						'section' => 'parvati_top_bar_typography',
						'settings' => array(
							'family' => 'parvati_settings[font_top_bar]',
							'variant' => 'font_top_bar_variants',
							'category' => 'font_top_bar_category',
							'weight' => 'parvati_settings[top_bar_font_weight]',
							'transform' => 'parvati_settings[top_bar_font_transform]',
						),
		...
		if ( isset( $defaults[ 'top_bar_font_size' ] ) && function_exists( 'parvati_is_top_bar_active' ) ) {
			// Font size
			$wp_customize->add_setting(
				'parvati_settings[top_bar_font_size]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Range_Slider_Control(
					...
					array(
						...
						'priority' => 75,
						'settings' => array(
							'desktop' => 'parvati_settings[top_bar_font_size]',
						),
						'choices' => array(
							'desktop' => array(
								'min' => 6,
		...
		// Font family
		$wp_customize->add_setting(
			'parvati_settings[font_site_title]',
			array(
		...
		// Font weight
		$wp_customize->add_setting(
			'parvati_settings[site_title_font_weight]',
			array(
		...
		// Text transform
		$wp_customize->add_setting(
			'parvati_settings[site_title_font_transform]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Typography_Customize_Control(
				...
				array(
					...
					'settings' => array(
						'family' => 'parvati_settings[font_site_title]',
						'variant' => 'font_site_title_variants',
						'category' => 'font_site_title_category',
						'weight' => 'parvati_settings[site_title_font_weight]',
						'transform' => 'parvati_settings[site_title_font_transform]',
					),
					'priority' => 50,
				)
			)
		...
		// Font size
		$wp_customize->add_setting(
			'parvati_settings[site_title_font_size]',
			array(
		...
		// Mobile font size
		$wp_customize->add_setting(
			'parvati_settings[mobile_site_title_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Range_Slider_Control(
				...
				array(
					...
					'priority' => 75,
					'settings' => array(
						'desktop' => 'parvati_settings[site_title_font_size]',
						'mobile' => 'parvati_settings[mobile_site_title_font_size]'
					),
					'choices' => array(
						'desktop' => array(
							'min' => 10,
		...
		// Tagline font family
		$wp_customize->add_setting(
			'parvati_settings[font_site_tagline]',
			array(
		...
		// Font weight
		$wp_customize->add_setting(
			'parvati_settings[site_tagline_font_weight]',
			array(
		...
		// Text transform
		$wp_customize->add_setting(
			'parvati_settings[site_tagline_font_transform]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Typography_Customize_Control(
				...
				array(
					'label' => __( 'Site Tagline', 'parvati-premium' ),
					'section' => 'font_header_section',
					'settings' => array(
						'family' => 'parvati_settings[font_site_tagline]',
						'variant' => 'font_site_tagline_variants',
						'category' => 'font_site_tagline_category',
						'weight' => 'parvati_settings[site_tagline_font_weight]',
						'transform' => 'parvati_settings[site_tagline_font_transform]',
					),
					'priority' => 80,
				)
			)
		...
		// Font size
		$wp_customize->add_setting(
			'parvati_settings[site_tagline_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Range_Slider_Control(
				...
				array(
					...
					'priority' => 105,
					'settings' => array(
						'desktop' => 'parvati_settings[site_tagline_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 6,
		...
		// Blog header title font family
		$wp_customize->add_setting(
			'parvati_settings[font_blog_header_title]',
			array(
				'default' => $defaults['font_blog_header_title'],
				'type' => 'option',
				'sanitize_callback' => 'sanitize_text_field'
			)
		);
		...
		// Font weight
		$wp_customize->add_setting(
			'parvati_settings[blog_header_title_font_weight]',
			array(
				'default' => $defaults['blog_header_title_font_weight'],
				'type' => 'option',
				'sanitize_callback' => 'sanitize_key'
			)
		);
		...
		// Text transform
		$wp_customize->add_setting(
			'parvati_settings[blog_header_title_font_transform]',
			array(
				'default' => $defaults['blog_header_title_font_transform'],
				'type' => 'option',
				'sanitize_callback' => 'sanitize_key'
			)
		);
		...
		$wp_customize->add_control(
			new Parvati_Pro_Typography_Customize_Control(
				$wp_customize,
				'font_blog_header_title_control',
				array(
					'label' => __( 'Blog Header Title', 'parvati-premium' ),
					'section' => 'font_header_section',
					'settings' => array(
						'family' => 'parvati_settings[font_blog_header_title]',
						'variant' => 'font_blog_header_title_variants',
						'category' => 'font_blog_header_title_category',
						'weight' => 'parvati_settings[blog_header_title_font_weight]',
						'transform' => 'parvati_settings[blog_header_title_font_transform]',
					),
					'priority' => 110,
				)
			)
		...
		// Blog header text font family
		$wp_customize->add_setting(
			'parvati_settings[font_blog_header_text]',
			array(
				'default' => $defaults['font_blog_header_text'],
				'type' => 'option',
				'sanitize_callback' => 'sanitize_text_field'
			)
		);
		...
		// Font weight
		$wp_customize->add_setting(
			'parvati_settings[blog_header_text_font_weight]',
			array(
				'default' => $defaults['blog_header_text_font_weight'],
				'type' => 'option',
				'sanitize_callback' => 'sanitize_key'
			)
		);
		...
		// Text transform
		$wp_customize->add_setting(
			'parvati_settings[blog_header_text_font_transform]',
			array(
				'default' => $defaults['blog_header_text_font_transform'],
				'type' => 'option',
				'sanitize_callback' => 'sanitize_key'
			)
		);
		...
		$wp_customize->add_control(
			new Parvati_Pro_Typography_Customize_Control(
				$wp_customize,
				'font_blog_header_text_control',
				array(
					'label' => __( 'Blog Header Text', 'parvati-premium' ),
					'section' => 'font_header_section',
					'settings' => array(
						'family' => 'parvati_settings[font_blog_header_text]',
						'variant' => 'font_blog_header_text_variants',
						'category' => 'font_blog_header_text_category',
						'weight' => 'parvati_settings[blog_header_text_font_weight]',
						'transform' => 'parvati_settings[blog_header_text_font_transform]',
					),
					'priority' => 120,
				)
			)
		...
		// Font family
		$wp_customize->add_setting(
			'parvati_settings[font_navigation]',
			array(
		...
		// Font weight
		$wp_customize->add_setting(
			'parvati_settings[navigation_font_weight]',
			array(
		...
		// Text transform
		$wp_customize->add_setting(
			'parvati_settings[navigation_font_transform]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Typography_Customize_Control(
				...
				array(
					...
					'settings' => array(
						'family' => 'parvati_settings[font_navigation]',
						'variant' => 'font_navigation_variants',
						'category' => 'font_navigation_category',
						'weight' => 'parvati_settings[navigation_font_weight]',
						'transform' => 'parvati_settings[navigation_font_transform]',
					),
					'priority' => 120,
				)
			)
		...
		$wp_customize->add_setting(
			'parvati_settings[navigation_font_size]',
			array(
		...
		$wp_customize->add_setting(
			'parvati_settings[tablet_navigation_font_size]',
			array(
		...
		$wp_customize->add_setting(
			'parvati_settings[mobile_navigation_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Range_Slider_Control(
				...
				array(
					...
					'priority' => 165,
					'settings' => array(
						'desktop' => 'parvati_settings[navigation_font_size]',
						'tablet' => 'parvati_settings[tablet_navigation_font_size]',
						'mobile' => 'parvati_settings[mobile_navigation_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 10,
		...
		if ( isset( $defaults['font_buttons'] ) ) {
			...
			$wp_customize->add_setting(
				'parvati_settings[buttons_font_weight]',
				array(
			...
			$wp_customize->add_setting(
				'parvati_settings[buttons_font_transform]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Typography_Customize_Control(
					...
					array(
						...
						'settings' => array(
							'family' => 'parvati_settings[font_buttons]',
							'variant' => 'font_buttons_variants',
							'category' => 'font_buttons_category',
							'weight' => 'parvati_settings[buttons_font_weight]',
							'transform' => 'parvati_settings[buttons_font_transform]',
						),
					)
				)
			);
			...
			$wp_customize->add_setting(
				'parvati_settings[buttons_font_size]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Range_Slider_Control(
					...
					array(
						...
						'section' => 'font_buttons_section',
						'settings' => array(
							'desktop' => 'parvati_settings[buttons_font_size]'
						),
						'choices' => array(
							'desktop' => array(
								'min' => 5,
		...
		$wp_customize->add_section(
			...
			array(
				'title' => __( 'Headings', 'parvati-premium' ),
				'capability' => 'edit_theme_options',
				'description' => '',
				'priority' => 60,
				'panel' => 'parvati_typography_panel'
		...
		// H1
		$wp_customize->add_setting(
			'parvati_settings[font_heading_1]',
			array(
		...
		$wp_customize->add_setting(
			'parvati_settings[heading_1_weight]',
			array(
		...
		$wp_customize->add_setting(
			'parvati_settings[heading_1_transform]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Typography_Customize_Control(
				...
				array(
					'label' => __( 'Heading 1 (H1)', 'parvati-premium' ),
					'section' => 'font_content_section',
					'settings' => array(
						'family' => 'parvati_settings[font_heading_1]',
						'variant' => 'font_heading_1_variants',
						'category' => 'font_heading_1_category',
						'weight' => 'parvati_settings[heading_1_weight]',
						'transform' => 'parvati_settings[heading_1_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_setting(
			'parvati_settings[heading_1_font_size]',
			array(
		...
		$wp_customize->add_setting(
			'parvati_settings[mobile_heading_1_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_content_section',
					'settings' => array(
						'desktop' => 'parvati_settings[heading_1_font_size]',
						'mobile' => 'parvati_settings[mobile_heading_1_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 15,
		...
		if ( isset( $defaults['heading_1_line_height'] ) ) {
			// Line height
			$wp_customize->add_setting(
				'parvati_settings[heading_1_line_height]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Range_Slider_Control(
					...
					array(
						...
						'section' => 'font_content_section',
						'settings' => array(
							'desktop' => 'parvati_settings[heading_1_line_height]',
						),
						'choices' => array(
							'desktop' => array(
								'min' => 0,
		...
		// H2
		$wp_customize->add_setting(
			'parvati_settings[font_heading_2]',
			array(
		...
		$wp_customize->add_setting(
			'parvati_settings[heading_2_weight]',
			array(
		...
		$wp_customize->add_setting(
			'parvati_settings[heading_2_transform]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Typography_Customize_Control(
				...
				array(
					'label' => __( 'Heading 2 (H2)', 'parvati-premium' ),
					'section' => 'font_content_section',
					'settings' => array(
						'family' => 'parvati_settings[font_heading_2]',
						'variant' => 'font_heading_2_variants',
						'category' => 'font_heading_2_category',
						'weight' => 'parvati_settings[heading_2_weight]',
						'transform' => 'parvati_settings[heading_2_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_setting(
			'parvati_settings[heading_2_font_size]',
			array(
		...
		$wp_customize->add_setting(
			'parvati_settings[mobile_heading_2_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_content_section',
					'settings' => array(
						'desktop' => 'parvati_settings[heading_2_font_size]',
						'mobile' => 'parvati_settings[mobile_heading_2_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 10,
		...
		if ( isset( $defaults['heading_2_line_height'] ) ) {
			// Line height
			$wp_customize->add_setting(
				'parvati_settings[heading_2_line_height]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Range_Slider_Control(
					...
					array(
						...
						'section' => 'font_content_section',
						'settings' => array(
							'desktop' => 'parvati_settings[heading_2_line_height]',
						),
						'choices' => array(
							'desktop' => array(
								'min' => 0,
		...
		// H3
		$wp_customize->add_setting(
			'parvati_settings[font_heading_3]',
			array(
		...
		$wp_customize->add_setting(
			'parvati_settings[heading_3_weight]',
			array(
		...
		$wp_customize->add_setting(
			'parvati_settings[heading_3_transform]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Typography_Customize_Control(
				...
				array(
					'label' => __( 'Heading 3 (H3)', 'parvati-premium' ),
					'section' => 'font_content_section',
					'settings' => array(
						'family' => 'parvati_settings[font_heading_3]',
						'variant' => 'font_heading_3_variants',
						'category' => 'font_heading_3_category',
						'weight' => 'parvati_settings[heading_3_weight]',
						'transform' => 'parvati_settings[heading_3_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_setting(
			'parvati_settings[heading_3_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_content_section',
					'settings' => array(
						'desktop' => 'parvati_settings[heading_3_font_size]'
					),
					'choices' => array(
						'desktop' => array(
							'min' => 10,
		...
		if ( isset( $defaults['heading_3_line_height'] ) ) {
			// Line height
			$wp_customize->add_setting(
				'parvati_settings[heading_3_line_height]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Range_Slider_Control(
					...
					array(
						...
						'section' => 'font_content_section',
						'settings' => array(
							'desktop' => 'parvati_settings[heading_3_line_height]',
						),
						'choices' => array(
							'desktop' => array(
								'min' => 0,
		...
		if ( isset( $defaults['font_heading_4'] ) ) {
			// H4
			$wp_customize->add_setting(
				'parvati_settings[font_heading_4]',
				array(
			...
			$wp_customize->add_setting(
				'parvati_settings[heading_4_weight]',
				array(
			...
			$wp_customize->add_setting(
				'parvati_settings[heading_4_transform]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Typography_Customize_Control(
					...
					array(
						'label' => __( 'Heading 4 (H4)', 'parvati-premium' ),
						'section' => 'font_content_section',
						'settings' => array(
							'family' => 'parvati_settings[font_heading_4]',
							'variant' => 'font_heading_4_variants',
							'category' => 'font_heading_4_category',
							'weight' => 'parvati_settings[heading_4_weight]',
							'transform' => 'parvati_settings[heading_4_transform]',
						),
					)
				)
			);
			...
			$wp_customize->add_setting(
				'parvati_settings[heading_4_font_size]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Range_Slider_Control(
					...
					array(
						...
						'section' => 'font_content_section',
						'settings' => array(
							'desktop' => 'parvati_settings[heading_4_font_size]'
						),
						'choices' => array(
							'desktop' => array(
								'min' => 10,
			...
			// Line height
			$wp_customize->add_setting(
				'parvati_settings[heading_4_line_height]',
				array(
					'default' => $defaults['heading_4_line_height'],
					'type' => 'option',
					'sanitize_callback' => 'parvati_premium_sanitize_decimal_integer_empty',
					'transport' => 'postMessage'
				)
			);
			...
			$wp_customize->add_control(
				new Parvati_Pro_Range_Slider_Control(
					...
					array(
						...
						'section' => 'font_content_section',
						'settings' => array(
							'desktop' => 'parvati_settings[heading_4_line_height]',
						),
						'choices' => array(
							'desktop' => array(
								'min' => 0,
		...
		if ( isset( $defaults['font_heading_5'] ) ) {
			// H5
			$wp_customize->add_setting(
				'parvati_settings[font_heading_5]',
				array(
			...
			$wp_customize->add_setting(
				'parvati_settings[heading_5_weight]',
				array(
			...
			$wp_customize->add_setting(
				'parvati_settings[heading_5_transform]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Typography_Customize_Control(
					...
					array(
						'label' => __( 'Heading 5 (H5)', 'parvati-premium' ),
						'section' => 'font_content_section',
						'settings' => array(
							'family' => 'parvati_settings[font_heading_5]',
							'variant' => 'font_heading_5_variants',
							'category' => 'font_heading_5_category',
							'weight' => 'parvati_settings[heading_5_weight]',
							'transform' => 'parvati_settings[heading_5_transform]',
						),
					)
				)
			);
			...
			$wp_customize->add_setting(
				'parvati_settings[heading_5_font_size]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Range_Slider_Control(
					...
					array(
						...
						'section' => 'font_content_section',
						'settings' => array(
							'desktop' => 'parvati_settings[heading_5_font_size]'
						),
						'choices' => array(
							'desktop' => array(
								'min' => 10,
			...
			// Line height
			$wp_customize->add_setting(
				'parvati_settings[heading_5_line_height]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Range_Slider_Control(
					...
					array(
						...
						'section' => 'font_content_section',
						'settings' => array(
							'desktop' => 'parvati_settings[heading_5_line_height]',
						),
						'choices' => array(
							'desktop' => array(
								'min' => 0,
		...
		if ( isset( $defaults['font_heading_6'] ) ) {
			// H5
			$wp_customize->add_setting(
				'parvati_settings[font_heading_6]',
				array(
			...
			$wp_customize->add_setting(
				'parvati_settings[heading_6_weight]',
				array(
			...
			$wp_customize->add_setting(
				'parvati_settings[heading_6_transform]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Typography_Customize_Control(
					...
					array(
						'label' => __( 'Heading 6 (H6)', 'parvati-premium' ),
						'section' => 'font_content_section',
						'settings' => array(
							'family' => 'parvati_settings[font_heading_6]',
							'variant' => 'font_heading_6_variants',
							'category' => 'font_heading_6_category',
							'weight' => 'parvati_settings[heading_6_weight]',
							'transform' => 'parvati_settings[heading_6_transform]',
						),
					)
				)
			);
			...
			$wp_customize->add_setting(
				'parvati_settings[heading_6_font_size]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Range_Slider_Control(
					...
					array(
						...
						'section' => 'font_content_section',
						'settings' => array(
							'desktop' => 'parvati_settings[heading_6_font_size]'
						),
						'choices' => array(
							'desktop' => array(
								'min' => 10,
			...
			// Line height
			$wp_customize->add_setting(
				'parvati_settings[heading_6_line_height]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Range_Slider_Control(
					...
					array(
						...
						'section' => 'font_content_section',
						'settings' => array(
							'desktop' => 'parvati_settings[heading_6_line_height]',
						),
						'choices' => array(
							'desktop' => array(
								'min' => 0,
		...
		$wp_customize->add_section(
			'font_widget_section',
			array(
				'title' => __( 'Widgets', 'parvati-premium' ),
				'capability' => 'edit_theme_options',
				'description' => '',
				'priority' => 60,
				'panel' => 'parvati_typography_panel'
		...
		// Font family
		$wp_customize->add_setting(
			'parvati_settings[font_widget_title]',
			array(
		...
		// Font weight
		$wp_customize->add_setting(
			'parvati_settings[widget_title_font_weight]',
			array(
		...
		// Text transform
		$wp_customize->add_setting(
			'parvati_settings[widget_title_font_transform]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Typography_Customize_Control(
				...
				array(
					'label' => __( 'Widget Titles', 'parvati-premium' ),
					'section' => 'font_widget_section',
					'settings' => array(
						'family' => 'parvati_settings[font_widget_title]',
						'variant' => 'font_widget_title_variants',
						'category' => 'font_widget_title_category',
						'weight' => 'parvati_settings[widget_title_font_weight]',
						'transform' => 'parvati_settings[widget_title_font_transform]',
					),
				)
			)
		);
		...
		// Font size
		$wp_customize->add_setting(
			'parvati_settings[widget_title_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_widget_section',
					'settings' => array(
						'desktop' => 'parvati_settings[widget_title_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 6,
		...
		if ( isset( $defaults['widget_title_separator'] ) ) {
			$wp_customize->add_setting(
				'parvati_settings[widget_title_separator]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Range_Slider_Control(
					...
					'parvati_settings[widget_title_separator]',
					array(
						'description' => __( 'Bottom margin', 'parvati-premium' ),
						'section' => 'font_widget_section',
						'settings' => array(
							'desktop' => 'parvati_settings[widget_title_separator]'
						),
						'choices' => array(
							'desktop' => array(
								'min' => 0,
		...
		$wp_customize->add_setting(
			'parvati_settings[widget_content_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Range_Slider_Control(
				...
				'parvati_settings[widget_content_font_size]',
				array(
					'description' => __( 'Content font size', 'parvati-premium' ),
					'section' => 'font_widget_section',
					'priority' => 240,
					'settings' => array(
						'desktop' => 'parvati_settings[widget_content_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 6,
		...
		if ( isset( $defaults['font_footer'] ) ) {
			...
			$wp_customize->add_setting(
				'parvati_settings[footer_weight]',
				array(
			...
			$wp_customize->add_setting(
				'parvati_settings[footer_transform]',
				array(
			...
			$wp_customize->add_control(
				new Parvati_Pro_Typography_Customize_Control(
					...
					array(
						...
						'settings' => array(
							'family' => 'parvati_settings[font_footer]',
							'variant' => 'font_footer_variants',
							'category' => 'font_footer_category',
							'weight' => 'parvati_settings[footer_weight]',
							'transform' => 'parvati_settings[footer_transform]',
						),
					)
				)
			);
		...
		// Font size
		$wp_customize->add_setting(
			'parvati_settings[footer_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Parvati_Pro_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_footer_section',
					'settings' => array(
						'desktop' => 'parvati_settings[footer_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 6,
...
if ( ! function_exists( 'parvati_enqueue_google_fonts' ) ) {
	add_action( 'wp_enqueue_scripts', 'parvati_enqueue_google_fonts', 0 );
	/**
	 * Enqueue Google Fonts.
	 *
	 */
	function parvati_enqueue_google_fonts() {
		// Bail if we don't have our defaults function
		if ( ! function_exists( 'parvati_get_default_fonts' ) ) {
			return;
		}
		...
		if ( ! empty( $font_settings ) ) {
			...
			foreach ( $font_settings as $key ) {
				...
				if ( ! isset( $parvati_settings[$key] ) ) {
					continue;
				}

				// If our value is still using the old format, fix it
				if ( strpos( $parvati_settings[$key], ':' ) !== false ) {
					$parvati_settings[$key] = current( explode( ':', $parvati_settings[$key] ) );
				}

				// Replace the spaces in the names with a plus
				$value = str_replace( ' ', '+', $parvati_settings[$key] );

				// Grab the variants using the plain name
				$variants = parvati_get_google_font_variants( $parvati_settings[$key], $key, parvati_get_default_fonts() );
		...
		$google_fonts = apply_filters( 'parvati_typography_google_fonts', $google_fonts );

		// Get the subset
		$subset = apply_filters( 'parvati_fonts_subset','' );
		...
		$default_fonts = PARVATI_PREMIUM_DEFAULT_FONTS;

		// Create our URL using the arguments
		$fonts_url = add_query_arg( $font_args, '//fonts.googleapis.com/css' );

		// Enqueue our fonts
			wp_enqueue_style('parvati-default-fonts', $default_fonts, array(), null, 'all' );
		if ( $google_fonts ) {
			wp_enqueue_style('parvati-fonts', $fonts_url, array(), null, 'all' );
		}
	}
}

if ( ! function_exists( 'parvati_get_all_google_fonts' ) ) {
	/**
	 * Return an array of all of our Google Fonts
	 */
	function parvati_get_all_google_fonts( $amount = 'all' ) {
		...
		if ( apply_filters( 'parvati_alphabetize_google_fonts', true ) ) {
			asort( $fonts );
		}

		// Filter to allow us to modify the fonts array
		return apply_filters( 'parvati_google_fonts_array', $fonts );
	}
}

if ( ! function_exists( 'parvati_get_all_google_fonts_ajax' ) ) {
	add_action( 'wp_ajax_parvati_get_all_google_fonts_ajax', 'parvati_get_all_google_fonts_ajax' );
	/**
	 * Return an array of all of our Google Fonts.
	 *
	 */
	function parvati_get_all_google_fonts_ajax() {
		...
		$fonts = apply_filters( 'parvati_typography_customize_list', parvati_get_all_google_fonts() );
...
if ( ! function_exists( 'parvati_get_google_font_variants' ) ) {
	 ...
	 * Example: parvati_get_google_font_variation( 'Open Sans' )
	 *
	 */
	function parvati_get_google_font_variants( $font, $key = '', $default = '' ) {
		// Bail if we don't have our defaults function
		if ( ! function_exists( 'parvati_get_default_fonts' ) ) {
			return;
		}
		...
		if ( in_array( $font, parvati_typography_default_fonts() ) ) {
			return;
		}
		...
		if ( '' == $default ) {
			$default = parvati_get_default_fonts();
		}
		...
		if ( $variants ) {
			...
			return implode(',', apply_filters( 'parvati_typography_variants', $output ));
		}

	}
}

if ( ! function_exists( 'parvati_get_google_font_category' ) ) {
	/**
	 * Wrapper function to find the category for chosen Google Font
	 * Example: parvati_get_google_font_category( 'Open Sans' )
	 *
	 */
	function parvati_get_google_font_category( $font, $key = '', $default = '' ) {
		// Bail if we don't have our defaults function
		if ( ! function_exists( 'parvati_get_default_fonts' ) ) {
			return;
		}
...
if ( ! function_exists( 'parvati_get_font_family_css' ) ) {
	 ...
	 *
	 */
	function parvati_get_font_family_css( $font, $settings, $default ) {
		$parvati_settings = wp_parse_args(
		...
		$no_quotes = array(
			...
			apply_filters( 'parvati_typography_system_stack', '-apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"' )
		);

		// Get our font
		$font_family = $parvati_settings[ $font ];

		if ( 'System Stack' == $font_family ) {
	 		$font_family = apply_filters( 'parvati_typography_system_stack', '-apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"' );
		}
		...
		if ( in_array( $font_family, $no_quotes ) ) {
			...
			$wrapper_start = '"';
			$wrapper_end = '"' . parvati_get_google_font_category( $font_family, $font, $default );
		}
...
if ( ! function_exists( 'parvati_typography_customizer_live_preview' ) ) {
	add_action( 'customize_preview_init', 'parvati_typography_customizer_live_preview' );
	/**
	 * Add our live preview JS
	 */
	function parvati_typography_customizer_live_preview() {
		wp_enqueue_script(
			  'parvati-typography-customizer',
			  trailingslashit( plugin_dir_url( __FILE__ ) ) . 'js/customizer.js',
			  array( 'jquery','customize-preview' ),
			  PARVATI_FONT_VERSION,
			  true
		);

		wp_localize_script( 'parvati-typography-customizer', 'gp_typography', array(
...
if ( ! function_exists( 'parvati_include_typography_defaults' ) ) {
	/**
	 * Check if we should include our default.css file 
	 */
	function parvati_include_typography_defaults() {
		return true;
	}
}

if ( ! function_exists( 'parvati_typography_premium_css_defaults' ) ) {
	add_filter( 'parvati_font_option_defaults', 'parvati_typography_premium_css_defaults' );
	/**
	 * Add premium control defaults
	 *
	 */
	function parvati_typography_premium_css_defaults( $defaults ) {
		$defaults[ 'mobile_navigation_font_size' ] = '18';
		$defaults[ 'tablet_navigation_font_size' ] = '12';
		return $defaults;
	}
}

if ( ! function_exists( 'parvati_typography_premium_css' ) ) {
	add_filter( 'parvati_typography_css_output', 'parvati_typography_premium_css' );
	/**
	 * Add premium control CSS
	 *
	 */
	function parvati_typography_premium_css( $css ) {
		...
		if ( '' !== $parvati_settings['mobile_navigation_font_size'] ) {
			$mobile_subnav_font_size = $parvati_settings['mobile_navigation_font_size'] >= 17 ? $parvati_settings['mobile_navigation_font_size'] - 3 : $parvati_settings['mobile_navigation_font_size'] - 1;
		}
		
		// Navigation font size under 1024px
		if ( ( '' !== parvati_get_navigation_location() || is_customize_preview() ) && '' !== $parvati_settings[ 'tablet_navigation_font_size' ] ) {
			$premium_css->start_media_query( apply_filters( 'parvati_mobile_media_query', '(max-width:1024px)' ) );
			$premium_css->set_selector( '.main-navigation:not(.slideout-navigation) a' );
			$premium_css->add_property( 'font-size', absint( $parvati_settings[ 'tablet_navigation_font_size' ] ), false, 'px' );
		}

		// Mobile
		$premium_css->start_media_query( apply_filters( 'parvati_mobile_media_query', '(max-width:768px)' ) );
			if ( ( '' !== parvati_get_navigation_location() || is_customize_preview() ) && '' !== $parvati_settings[ 'mobile_navigation_font_size' ] ) {
				$premium_css->set_selector( '.main-navigation:not(.slideout-navigation) a, .menu-toggle' );
				$premium_css->add_property( 'font-size', absint( $parvati_settings[ 'mobile_navigation_font_size' ] ), false, 'px' );
