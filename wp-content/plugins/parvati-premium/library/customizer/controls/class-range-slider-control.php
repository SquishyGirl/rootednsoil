...
if ( ! function_exists( 'Parvati_Pro_Range_Slider_Control' ) ) :
class Parvati_Pro_Range_Slider_Control extends WP_Customize_Control {
	/**
	 * The control type.
	 *
	 * @var string
	 */
	public $type = 'parvati-pro-range-slider';
	...
	public function to_json() {
		...
		$this->json['desktop_label'] = __( 'Desktop', 'parvati-premium' );
		$this->json['tablet_label'] = __( 'Tablet', 'parvati-premium' );
		$this->json['mobile_label'] = __( 'Mobile', 'parvati-premium' );
		$this->json['reset_label'] = __( 'Reset', 'parvati-premium' );
	...
	public function enqueue() {
		wp_enqueue_script( 'parvati-pro-range-slider', trailingslashit( plugin_dir_url( __FILE__ ) ) . 'js/slider-customizer.js', array( 'jquery', 'customize-base', 'jquery-ui-slider' ), PARVATI_PREMIUM_VERSION, true );
		wp_enqueue_style( 'parvati-pro-range-slider-css', trailingslashit( plugin_dir_url( __FILE__ ) ) . 'css/slider-customizer.css', PARVATI_PREMIUM_VERSION );
	}
	/**
