...
function generateHeaderHeight() {
	...
	} else if ( jQuery( '.parvati-inside-combined-content' ).length ) {
		page_header_content = jQuery( '.parvati-inside-combined-content' );
	} else {
		page_header_content = jQuery( '.parvati-inside-page-header-content' );
	}
...
jQuery(document).ready(function($) {
	...
	if ( jQuery('.parvati-page-header.fullscreen-enabled')[0] ) {
