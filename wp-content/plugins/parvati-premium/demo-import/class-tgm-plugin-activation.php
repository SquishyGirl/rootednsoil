...
add_action( 'tgmpa_register', 'parvati_premium_register_required_plugins' );

function parvati_premium_register_required_plugins() {
	/*
	...
	$config = array(
		'id'           => 'parvati-premium',                 // Unique ID for hashing notices for multiple instances of TGMPA.
