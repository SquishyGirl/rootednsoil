 ...
 * Empty:  transparent
 */
parvati_colors_live_update( 'slideout_background_color', '.main-navigation.slideout-navigation', 'background-color', '' );

/**
 * Primary navigation text color
 * Empty:  link_color
 */
parvati_colors_live_update( 'slideout_text_color', '.slideout-navigation.main-navigation .main-nav ul li a', 'color', '' );

/**
 * Primary navigation text color hover
 * Empty:  link_color_hover
 */
parvati_colors_live_update( 'slideout_text_hover_color',
 ...
 * Empty:  link_color_hover
 */
parvati_colors_live_update( 'slideout_background_hover_color',
	'.slideout-navigation.main-navigation .main-nav ul li:hover > a,\
	.slideout-navigation.main-navigation .main-nav ul li:focus > a,\
	.slideout-navigation.main-navigation .main-nav ul li.sfHover > a',
 ...
 * Empty:  transparent
 */
parvati_colors_live_update( 'slideout_submenu_background_color', '.slideout-navigation.main-navigation ul ul', 'background-color', '' );

/**
 * Primary sub-navigation text color
 * Empty:  link_color
 */
parvati_colors_live_update( 'slideout_submenu_text_color', '.slideout-navigation.main-navigation .main-nav ul ul li a', 'color', '' );
 ...
 * Empty: link_color_hover
 */
parvati_colors_live_update( 'slideout_submenu_text_hover_color', slideout_submenu_hover, 'color', '' );

/**
 * Primary sub-navigation background hover
 * Empty: transparent
 */
parvati_colors_live_update( 'slideout_submenu_background_hover_color', slideout_submenu_hover, 'background-color', '' );
 ...
 * Empty: link_color
 */
parvati_colors_live_update( 'slideout_text_current_color', slideout_current, 'color', '' );

/**
 * Primary navigation current text
 * Empty: transparent
 */
parvati_colors_live_update( 'slideout_background_current_color', slideout_current, 'background-color' );
 ...
 * Empty: link_color
 */
parvati_colors_live_update( 'slideout_submenu_text_current_color', slideout_submenu_current, 'color', '' );

/**
 * Primary navigation current item background
 * Empty: transparent
 */
parvati_colors_live_update( 'slideout_submenu_background_current_color', slideout_submenu_current, 'background-color' );
